...
SOURCE_URLS = [
    ""httpsbestcf.pages.dev/domain/ygkkk/all.txt",
    ""httpsbestcf.pages.dev/domain/qms/all.txt",
    ""httpsbestcf.pages.dev/domain/senflare/all.txt",
    ""httpsbestcf.pages.dev/domain/wuya/all.txt",
    ""httpsbestcf.pages.dev/domain/ircf/all.txt",
    ""httpsbestcf.pages.dev/wetest/ipv4.txt",
    ""httpsbestcf.pages.dev/uouin/all.txt",
    ""httpsbestcf.pages.dev/luoli/all.txt",
    ""httpsbestcf.pages.dev/cfyes/ipv4.txt",
    ""httpsbestcf.pages.dev/tiancheng/all.txt",
    ""httpsbestcf.pages.dev/s5gy/all.txt",
    ""httpscf.junzhen.qzz.io/best_ips.txt",
    ""httpsraw.githubusercontent.com/love-ztm/cfip/refs/heads/main/ubest_ips.txt",
    ""httpsbestcf.pages.dev/zhixuanwang/ipv4-onlyip.txt",
    ""httpsbestcf.pages.dev/vvhan/ipv4.txt",
    ""httpsraw.githubusercontent.com/ymyuuu/IPDB/refs/heads/main/BestCF/bestcfv4.txt",
    ""httpsraw.githubusercontent.com/yuanxiawan/cfipv4db/refs/heads/main/cfip.txt",
    ""httpsbestcf.pages.dev/cmliu/all.txt",
    ""httpsbestcf.pages.dev/cmliu2/all.txt",
    ""httpsbestcf.pages.dev/lzj/all.txt",
    ""httpsraw.githubusercontent.com/joname1/BestCFip/refs/heads/main/ipv4.txt",
    ""httpsbestcf.pages.dev/random-region/US/all.txt",
    ""httpsbestcf.pages.dev/random-region/DE/all.txt",
    ""httpsbestcf.pages.dev/random-region/NL/all.txt",    
]
...
def format_node_group(nodes_list, res_tag_force=False):
    ...
    for idx, item in enumerate(nodes_list, start=1):
        ...
        node_name = f"{flag} {c_name} {idx:02d}{tag} - xingfei"
